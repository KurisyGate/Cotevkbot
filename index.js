...
vk.updates.use(async (message, next) => {  	
	...
	if(/\[club184991221\|(.*)\]/i.test(message.text)) message.text = message.text.replace(/\[club184991221\|(.*)\]/ig, '').trim();
...
👤 Владельцы: 
&#8195;👤 @xxxseenpai(Олег Исаченко)

👮 Спонсоры:
 &#8195;👮 

👷 Кодер: 
xxxseenpai @xxxseenpai(Олежа)
🔰 Информация о железе:
